  ...
  <div class="login">
    ...
    <div class="login-content">
      <div class="login-card">
        <p class="welcome blue--text">Welcome</p>
        <p
          class="welcome-text"
        >This is where the magic happens! Log in with your admin credentials to proceed</p>
        ...
        <p class="contact">
          ...
          <span class="blue--text">Contact the engineering team</span>
        </p>
      </div>
    </div>
  </div>
